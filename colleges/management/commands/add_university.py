...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        UniversityBranch.objects.create(
            branch_name="PUP Sta. Mesa, Manila", regional_group="Metro Manila"
        )
        UniversityBranch.objects.create(
            branch_name="PUP Taguig", regional_group="Metro Manila"
        )
        UniversityBranch.objects.create(
            branch_name="PUP Quezon", regional_group="Metro Manila"
        )
        UniversityBranch.objects.create(
            branch_name="PUP San Juan", regional_group="Metro Manila"
        )
